        ...
        <div class="col-lg-3 mb-4">
          <div class="card h-100 shadow">
            <div class="card-header bg-primary">
              <?php
              $ratingx = $this->db->query('select c.culinary_id, c.image, c.name, c.address, c.wifi_id, c.link, (select sum(r.total_nilai)/count(r.culinary_id) from rating r where r.culinary_id=c.culinary_id) as total_nilai from culinary c where c.culinary_id = ' . $c->culinary_id . ' order by total_nilai desc')->result();
              ?>
